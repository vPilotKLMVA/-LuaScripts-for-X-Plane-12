...
[![Version](https://img.shields.io/badge/version-1.4.7-blue.svg)](https://github.com/vPilotKLMVA/-LuaScripts-for-X-Plane-12)
...
2. **Install vATC Sync**
   ...
   - Copy `vATC_v1.4.7.lua` to `FlyWithLua/Scripts/`
